...
Non-Relational:
    ...
    - Flexible Structure 
    - Uses a Primary Key (ID) to give individually to each document 
...
- Uses hashtags and salting to hide the password/value so it's nearly impossible to decrypt (hack//solve encryption)
